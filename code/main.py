...
def main(a_pose_name: str, idle_loop_name: str, b_pose_name: str = None, a_to_idle_blend_length: int = 30,
         ...
         a_pose_end_frame: Optional[int] = None, b_pose_end_frame: Optional[int] = None):
    if snapped:
    ...
    configuration = dict(idle_loop_fbx_path=idle_loops_path,
                         ...
                         animation_group_name=settings.animation_group_name, a_pose_range=a_pose_end_frame,
                         b_pose_range=b_pose_end_frame)
